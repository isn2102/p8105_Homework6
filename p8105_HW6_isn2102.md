...
distribution, and calculate the mean RMSE. Because the smallest
distribution is for the prelim5 model which I initially fit, and because
we can see that prelim5 also has the smallest average RMSE, we can
conclude that prelim5 predicts birthweight the best in our test data.
...
<img src="p8105_HW6_isn2102_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />
...
function to extract log(beta0xbeta1).
...
```
    ...
    ## # A tibble: 10 x 3
    ##    strap_number r.squared log_betas
    ##    <chr>            <dbl>     <dbl>
    ##  1 01               0.913      2.03
    ##  2 02               0.910      2.03
    ##  3 03               0.911      2.05
